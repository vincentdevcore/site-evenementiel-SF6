# 🥊 Street Fighter 6 Tournament Website
...
* Hero section immersive inspirée de **Street Fighter 6**
* Design responsive (**mobile, tablette, laptop et desktop**)
* Présentation du tournoi
* Système d’inscription des joueurs
* Sélection du personnage joué
* Sélection du rank joueur
* Affichage du prochain match
* Tableau du tournoi (**bracket system**)

### 🔐 Administration

* Connexion administrateur sécurisée
* Gestion des inscriptions
* Validation / refus des participants
* Gestion du tournoi
